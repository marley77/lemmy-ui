...
export class Navbar extends Component<NavbarProps, NavbarState> {
  ...
  ================ */}
          ...
          {this.state.isLoggedIn ? (
            <>
              <a
                href={`/u/${UserService.Instance.myUserInfo.local_user_view.person.name}`}
                id="profie"
              >
                {person.avatar ? (
...
*/}
          ...
          <div id="topastro" onClick={boostmenu}>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
          ...
          <div id="bm-wrap" style="display: none;">
            <div id="tito">
              <br />
              <a href="//biglifeboost.quest/c/enlightenment/">
                <span id="boosticon">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
                    data-icon="gripfire"
                    class="svg-inline--fa fa-gripfire fa-w-12"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 384 512"
                  >
              ...
              <div id="bothalf">
                <a href="//biglifeboost.quest/wisdom/videos/">
                  <span id="boosticon">
                    <svg
                      aria-hidden="true"
                      focusable="false"
          ...
          <div id="deskmenu">
            ...
            <a id="dm1" href="//biglifeboost.quest/wisdom/all-boosts/">
              ✧ Wiz{" "}
            </a>
            ...
            {/*    settings ================ */}
            <a id="dm1" href="/settings" title="settings">
              {" "}
              <Icon icon="settings" />
            </a>
